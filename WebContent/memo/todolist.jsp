				...
				<div class="card px-3">
					<div class="card-body">
						...
						<div class="add-items d-flex">
							...
							<button onclick="reminderWrite(${sessionScope.principal.id})" type="button" id="close" class="add btn btn-primary font-weight-bold todo-list-add-btn">Add</button>
						</div>

						<c:forEach var="reminder" items="${reminders}">
				
							<div id="reminder-${reminder.id}" class="list-wrapper">
								<ul class="d-flex flex-column-reverse todo-list">
									<li>
										<div class="form-check">
											<label class="form-check-label"> <i onclick="reminderCheck(${reminder.id}, ${reminder.priority})" class="material-icons" id="reminderCheck-${reminder.priority}">check_box</i>
