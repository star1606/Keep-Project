					...
					<c:when test="${empty sessionScope.principal}">
						...
						<form action="/keep/person?cmd=loginProc" class="login100-form validate-form" method="POST">
							...
							<div class="wrap-input100 validate-input" data-validate="이메일 양식을 입력 올바르지 않습니다: ex@abc.com">
								<input class="input100" type="text" value="${cookie.remember.value }" name="email" placeholder="Email"> <span class="focus-input100-1"></span> <span class="focus-input100-2"></span>
							</div>

							<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
								<input class="input100" type="password" name="password" placeholder="Password"> <span class="focus-input100-1"></span> <span class="focus-input100-2"></span>
							</div>
							...
							<div class="container-login100-form-btn m-t-20 justify-content-center">
								<a href="https://kauth.kakao.com/oauth/authorize?client_id=69df22722bf186a619e27a21cba0f9fa&redirect_uri=http://localhost:8000/keep/oauth/kakao?cmd=callback&response_type=code"> <img
									width="390px" height="60px" src="/keep/static/image/kakao_login_medium_wide.png"></img></a>
							</div>
							...
							<div class="text-center">
								<span class="txt1"> Create an email? </span> <a href="/keep/person?cmd=join" class="txt2 hov1"> 이메일 만들기 </a>
							</div>
						</form>
					</c:when>
